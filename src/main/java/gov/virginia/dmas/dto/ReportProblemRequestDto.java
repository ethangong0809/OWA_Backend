...
@Conditional(selected = "category", values = {"Medicaid Member"}, required = {"memFirstname", "memLastname", "memPhone", "memEmail", "confirmMemEmail"})
@Conditional(selected = "category", values = {"Assisting a Medicaid Member"}, required = {"relationship", "memFirstname", "memLastname"})
...
@FieldsEquality(firstFieldName = "memEmail", secondFieldName = "confirmMemEmail")
public class ReportProblemRequestDto implements Serializable{
	...
	@ExtendedEmailValidator
	private String confirmMemEmail;
